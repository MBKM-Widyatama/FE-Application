...
export default function PageSignIn() {
  ...
  return (
    <Row align="top" gutter={[0, 40]} style={{ padding: 100, paddingTop: 60 }}>
      <Col span={24} style={{ textAlign: 'center' }}>
        <Title style={{ fontSize: 36, fontWeight: 700 }}>BIMAUTAMA News</Title>
      </Col>
      <Col span={16}>
        {[1, 2, 3].map((item: any) => (
      ...
      <Col span={8} style={{ paddingLeft: 58 }}>
        <Paragraph style={{ fontWeight: 600, fontSize: 16, marginBottom: 30 }}>
