...
import { Lecturer } from '@services/masterData/lecturer/types'
...
export default function Lecturers() {
  ...
  const [detailData, setDetailData] = useState<Lecturer | null>(null)
  ...
  const { data } = useQuery(['lecturers', page], async () => service.get(), {
    onError: (error: any) =>
      setSnackbar({
        open: true,
